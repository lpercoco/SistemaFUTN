...
<!-- Cambiar a jsp?
     esta bien el ingresar el password aca?
     hacer externo el script?
 --> 
    ...
    <h2>Add a new student</h2>
      ...
      <form  name="UserAddForm" action="UserAdd" method="post"> 
        ...
        <input type="text" name="legajo" id="legajo" placeholder="Legajo" required autofocus>
        </div>
        ...
        <input type="tel" name="phone1" id="phone1" placeholder="Phone" required> 
        </div>
        
        <div class="form-group">
        <label for="phone2" class="sr-only" >Phone 2</label>
        <input type="tel" name="phone2" id="phone2"placeholder="Phone 2" > 
        </div>
        ...
        <div class="form-group">
        <label for="credit" class="sr-only" >Credit</label>
        <input type="number" name="credit" id="credit" step="1" min="0" placeholder="Credit" required> 
        </div>
